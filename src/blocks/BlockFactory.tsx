import { QuicksFeedComponent, QuicksComposerComponent } from './QuicksApp'
...
export default class BlockFactory {
  static getFeedComponent(model: BlockModel) {
    switch (model.type) {
      ...
      case "Quicks": return <QuicksFeedComponent model={model} />;
  ...
  static getComposerComponent(props: ComposerComponentProps) {
    ...
    switch (model.type) {
      ...
      case "Quicks": return QuicksComposerComponent(props);
