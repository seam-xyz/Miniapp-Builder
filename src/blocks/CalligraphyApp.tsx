...
export const CalligraphyFeedComponent = ({ model }: FeedComponentProps) => {
  return (
    <img src={model.data["imageData"]} alt='a drawing' className='w-full object-contain'></img>
  );
}

export const CalligraphyComposerComponent = ({ model, done, width }: ComposerComponentProps) => {
  const onSave = () => done(model)
