...
import BmiIcon from "./blockIcons/BMIIcon.png";
...
export const BlockTypes: { [key: string]: BlockType } = {
  ...
  "Bmi": {
    type: "Bmi",
    displayName: "BMI",
    displayDescription: "Calculate and share your Body Mass Index (BMI) with your friends and take control of your health",
    icon: BmiIcon, // TODO: insert your app icon here
    deprecated: false,
    doesBlockPost: true,
    doesBlockEdit: true,
